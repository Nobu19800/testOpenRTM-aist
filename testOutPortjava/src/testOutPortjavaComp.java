 ...
 *
 */
public class testOutPortjavaComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testOutPortjava.component_conf);
      mgr.registerFactory(prop, new testOutPortjava(), new testOutPortjava());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testOutPortjava");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testOutPortjavaComp init = new testOutPortjavaComp();
