 ...
 *
 */
public class testOutPortjavaImpl extends DataFlowComponentBase {

  /**
   * constructor
   * @param manager Manager Object
   */
    public testOutPortjavaImpl(Manager manager) {  
        super(manager);
        // <rtc-template block="initializer">
        m_out_val = new TimedCameraImage();
        m_out = new DataRef<TimedCameraImage>(m_out_val);
        m_outOut = new OutPort<TimedCameraImage>("out", m_out);
        // </rtc-template>
...
//
    ...
    /*!
     */
    protected OutPort<TimedCameraImage> m_outOut;
