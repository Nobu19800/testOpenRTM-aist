// -*- Java -*-
/*!
 * @file testOutPortjavaTestComp.java
...
/*!
 * @class testOutPortjavaTestComp
 * @brief Standalone component Class
 *
 */
public class testOutPortjavaTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testOutPortjavaTest.component_conf);
      mgr.registerFactory(prop, new testOutPortjavaTest(), new testOutPortjavaTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testOutPortjavaTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testOutPortjavaTestComp init = new testOutPortjavaTestComp();
