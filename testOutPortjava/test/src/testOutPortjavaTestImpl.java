// -*- Java -*-
/*!
 * @file  testOutPortjavaTestImpl.java
...
/*!
 * @class testOutPortjavaTestImpl
 * @brief ModuleDescription
 *
 */
public class testOutPortjavaTestImpl extends DataFlowComponentBase {

  /*!
   * @brief constructor
   * @param manager Maneger Object
   */
	public testOutPortjavaTestImpl(Manager manager) {  
        super(manager);
        // <rtc-template block="initializer">
        m_out_val = new TimedCameraImage();
        initializeParam(m_out_val);
        m_out = new DataRef<TimedCameraImage>(m_out_val);
        m_outIn = new InPort<TimedCameraImage>("out", m_out);
        // </rtc-template>
...
//
    ...
    protected TimedCameraImage m_out_val;
    protected DataRef<TimedCameraImage> m_out;
    /*!
     */
    protected InPort<TimedCameraImage> m_outIn;
