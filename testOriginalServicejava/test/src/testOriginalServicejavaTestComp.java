// -*- Java -*-
/*!
 * @file testOriginalServicejavaTestComp.java
...
/*!
 * @class testOriginalServicejavaTestComp
 * @brief Standalone component Class
 *
 */
public class testOriginalServicejavaTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testOriginalServicejavaTest.component_conf);
      mgr.registerFactory(prop, new testOriginalServicejavaTest(), new testOriginalServicejavaTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testOriginalServicejavaTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testOriginalServicejavaTestComp init = new testOriginalServicejavaTestComp();
