// -*- Java -*-
/*!
 * @file testOriginalServicejavaComp.java
...
/**
 * testOriginalServicejavaComp
 * <p>
 * Standalone component Class
 *
 */
public class testOriginalServicejavaComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testOriginalServicejava.component_conf);
      mgr.registerFactory(prop, new testOriginalServicejava(), new testOriginalServicejava());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testOriginalServicejava");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testOriginalServicejavaComp init = new testOriginalServicejavaComp();
