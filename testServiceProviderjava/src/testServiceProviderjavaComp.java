// -*- Java -*-
/*!
 * @file testServiceProviderjavaComp.java
...
/**
 * testServiceProviderjavaComp
 * <p>
 * Standalone component Class
 *
 */
public class testServiceProviderjavaComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testServiceProviderjava.component_conf);
      mgr.registerFactory(prop, new testServiceProviderjava(), new testServiceProviderjava());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testServiceProviderjava");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testServiceProviderjavaComp init = new testServiceProviderjavaComp();
