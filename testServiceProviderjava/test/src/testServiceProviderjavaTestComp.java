// -*- Java -*-
/*!
 * @file testServiceProviderjavaTestComp.java
...
/*!
 * @class testServiceProviderjavaTestComp
 * @brief Standalone component Class
 *
 */
public class testServiceProviderjavaTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testServiceProviderjavaTest.component_conf);
      mgr.registerFactory(prop, new testServiceProviderjavaTest(), new testServiceProviderjavaTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testServiceProviderjavaTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testServiceProviderjavaTestComp init = new testServiceProviderjavaTestComp();
