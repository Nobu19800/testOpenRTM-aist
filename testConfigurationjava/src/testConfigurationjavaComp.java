// -*- Java -*-
/*!
 * @file testConfigurationjavaComp.java
...
/**
 * testConfigurationjavaComp
 * <p>
 * Standalone component Class
 *
 */
public class testConfigurationjavaComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testConfigurationjava.component_conf);
      mgr.registerFactory(prop, new testConfigurationjava(), new testConfigurationjava());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testConfigurationjava");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testConfigurationjavaComp init = new testConfigurationjavaComp();
