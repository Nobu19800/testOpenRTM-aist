// -*- Java -*-
/*!
 * @file testConfigurationjava.java
 * @date $Date$
 *
 * $Id$
 */
...
/**
 * testConfigurationjava
 * <p> 
 * ModuleDescription
 */
public class testConfigurationjava implements RtcNewFunc, RtcDeleteFunc, RegisterModuleFunc {

//  Module specification
//  <rtc-template block="module_spec">
    public static String component_conf[] = {
            "implementation_id", "testConfigurationjava",
            "type_name",         "testConfigurationjava",
...
//  </rtc-template>
    ...
    public RTObject_impl createRtc(Manager mgr) {
        return new testConfigurationjavaImpl(mgr);
    }
    ...
    public void registerModule() {
        ...
        manager.registerFactory(prop, new testConfigurationjava(), new testConfigurationjava());
    }
}
