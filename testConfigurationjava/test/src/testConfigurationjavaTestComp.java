// -*- Java -*-
/*!
 * @file testConfigurationjavaTestComp.java
...
/*!
 * @class testConfigurationjavaTestComp
 * @brief Standalone component Class
 *
 */
public class testConfigurationjavaTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testConfigurationjavaTest.component_conf);
      mgr.registerFactory(prop, new testConfigurationjavaTest(), new testConfigurationjavaTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testConfigurationjavaTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testConfigurationjavaTestComp init = new testConfigurationjavaTestComp();
