// -*- Java -*-
/*!
 * @file  testInPortjavaTestImpl.java
...
/*!
 * @class testInPortjavaTestImpl
 * @brief ModuleDescription
 *
 */
public class testInPortjavaTestImpl extends DataFlowComponentBase {

  /*!
   * @brief constructor
   * @param manager Maneger Object
   */
	public testInPortjavaTestImpl(Manager manager) {  
        super(manager);
        // <rtc-template block="initializer">
        m_in_val = new TimedCameraImage();
        m_in = new DataRef<TimedCameraImage>(m_in_val);
        m_inOut = new OutPort<TimedCameraImage>("in", m_in);
        // </rtc-template>
...
//
    ...
    protected TimedCameraImage m_in_val;
    protected DataRef<TimedCameraImage> m_in;
    /*!
     */
    protected OutPort<TimedCameraImage> m_inOut;
