// -*- Java -*-
/*!
 * @file testInPortjavaTestComp.java
...
/*!
 * @class testInPortjavaTestComp
 * @brief Standalone component Class
 *
 */
public class testInPortjavaTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testInPortjavaTest.component_conf);
      mgr.registerFactory(prop, new testInPortjavaTest(), new testInPortjavaTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testInPortjavaTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testInPortjavaTestComp init = new testInPortjavaTestComp();
