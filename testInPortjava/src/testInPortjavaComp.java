 ...
 *
 */
public class testInPortjavaComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testInPortjava.component_conf);
      mgr.registerFactory(prop, new testInPortjava(), new testInPortjava());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testInPortjava");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testInPortjavaComp init = new testInPortjavaComp();
