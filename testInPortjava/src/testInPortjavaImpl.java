 ...
 *
 */
public class testInPortjavaImpl extends DataFlowComponentBase {

  /**
   * constructor
   * @param manager Manager Object
   */
    public testInPortjavaImpl(Manager manager) {  
        super(manager);
        // <rtc-template block="initializer">
        m_in_val = new TimedCameraImage();
        initializeParam(m_in_val);
        m_in = new DataRef<TimedCameraImage>(m_in_val);
        m_inIn = new InPort<TimedCameraImage>("in", m_in);
        // </rtc-template>
...
//
    ...
    /*!
     */
    protected InPort<TimedCameraImage> m_inIn;
