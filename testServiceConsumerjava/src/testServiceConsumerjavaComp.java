// -*- Java -*-
/*!
 * @file testServiceConsumerjavaComp.java
...
/**
 * testServiceConsumerjavaComp
 * <p>
 * Standalone component Class
 *
 */
public class testServiceConsumerjavaComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testServiceConsumerjava.component_conf);
      mgr.registerFactory(prop, new testServiceConsumerjava(), new testServiceConsumerjava());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testServiceConsumerjava");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testServiceConsumerjavaComp init = new testServiceConsumerjavaComp();
