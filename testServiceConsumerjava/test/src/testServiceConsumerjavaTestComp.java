// -*- Java -*-
/*!
 * @file testServiceConsumerjavaTestComp.java
...
/*!
 * @class testServiceConsumerjavaTestComp
 * @brief Standalone component Class
 *
 */
public class testServiceConsumerjavaTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testServiceConsumerjavaTest.component_conf);
      mgr.registerFactory(prop, new testServiceConsumerjavaTest(), new testServiceConsumerjavaTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testServiceConsumerjavaTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testServiceConsumerjavaTestComp init = new testServiceConsumerjavaTestComp();
