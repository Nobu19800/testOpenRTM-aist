// -*- Java -*-
/*!
 * @file testOriginalPortjavaComp.java
...
/**
 * testOriginalPortjavaComp
 * <p>
 * Standalone component Class
 *
 */
public class testOriginalPortjavaComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testOriginalPortjava.component_conf);
      mgr.registerFactory(prop, new testOriginalPortjava(), new testOriginalPortjava());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testOriginalPortjava");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testOriginalPortjavaComp init = new testOriginalPortjavaComp();
