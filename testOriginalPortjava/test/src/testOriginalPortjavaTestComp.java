// -*- Java -*-
/*!
 * @file testOriginalPortjavaTestComp.java
...
/*!
 * @class testOriginalPortjavaTestComp
 * @brief Standalone component Class
 *
 */
public class testOriginalPortjavaTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(testOriginalPortjavaTest.component_conf);
      mgr.registerFactory(prop, new testOriginalPortjavaTest(), new testOriginalPortjavaTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("testOriginalPortjavaTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        testOriginalPortjavaTestComp init = new testOriginalPortjavaTestComp();
